...
- **Remaining tools to convert (in order):** (1) Regional Center Scorecard (`/tools/eb5-regional-center-scorecard`), (2) EB-5 Feasibility Calculator (`/tools/2026-eb5-investment-feasibility-calculator`), (3) Tools hub page (`/eb5-investment-immigration-tools`).
