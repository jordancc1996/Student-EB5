...
image: ../../../assets/blog-f1-to-eb5-comprehensive-guide.jpg
heroImage: ../../../assets/blog-f1-to-eb5-hero.jpg
imageAlt: International graduate student at American university campus representing the F-1 to EB-5 green card transition
author: StudentEB5 Team
keywords:
  - F-1 visa to EB-5 green card
  - F-1 student EB-5 guide 2026
  - international student green card
  - EB-5 concurrent filing F-1
  - F-1 to green card investor
  - EB-5 Reform and Integrity Act
  - EB-5 grandfathering deadline 2026
  - OPT to EB-5
  - H-1B lottery alternative
  - EB-5 investment requirements
  - I-526E petition
  - I-485 adjustment of status
  - 90-day rule immigration
  - September 2026 EB-5 deadline
relatedPosts:
...
Many F-1 students apply for optional practical training after they graduate, which allows the student to work for up to 12 months in a job directly related to their field of study. Students with degrees in science, technology, engineering and mathematics usually take the additional 24 month extension to get 36 total months of OPT. OPT provides valuable work experience but is only a band aid to the long-term prospects of international students. When OPT ends the pressure to secure a more permanent visa status intensifies. Indian and Chinese STEM OPT graduates facing 2026 Duration of Status proposals and cap-gap risk should read our <a href="/research/f1-students/eb5-indian-chinese-students-f1-stem-opt">EB-5 for Indian and Chinese students on F-1 and STEM OPT</a>.
...
- **1. Identify a Project:** The investor selects a qualifying EB-5 project to invest in. This can be a direct investment in a new commercial enterprise or an investment in a project sponsored by a USCIS designated regional center. Learn how to <a href="/research/choosing-rural-eb5-regional-center-guide">choose a regional center</a>.
...
The <a href="/research/post-reform-integrity-act-analysis">EB-5 Reform and Integrity Act of 2022</a> brought about the most significant changes to the EB-5 program in decades. The act allows for concurrent filing of the I-526E petition and I-485 adjustment of status so the investor can receive their travel and work documents.
...
- **Form I-131:** Application for Travel Document (advance parole travel permit)

Filing all four together allows the student to legally remain in the United States, work for any employer including self-employment, and travel internationally while the EB-5 petition is pending.

## EB-5 Processing Timeline for F-1 Students

After concurrent filing of the I-526E, I-485, I-765 and I-131 with a regional center that already has a pre-approved I-956F, processing windows for F-1 students are generally as follows:

- **EAD and Advance Parole approval:** 3 to 6 months
- **I-526E approval:** as quick as 6 to 12 months
- **I-485 adjudication:** an estimated 6 to 8 months after I-526E approval

These windows shift based on USCIS workload, country of origin and project specifics.

## Form I-526E vs Form I-829

Form I-526E is the initial investor petition demonstrating a qualifying investment and a credible plan to create the required 10 jobs. With an approved or concurrently filed I-526E, an F-1 student can secure a two-year conditional green card.

Form I-829 is filed within the 90-day window before the conditional green card expires. It must demonstrate that the investment was sustained and that the 10 required jobs were created. Upon approval, the investor and family receive their unconditional permanent green cards.

The minimum sustainment period for post-RIA investments is two years from the date the capital is deployed, though regional center contracts often dictate a longer hold period.

## How F-1 Students Can Finance the EB-5 Investment

USCIS requires that all EB-5 capital be lawful and fully traceable. The five most common sources for F-1 students are:

### Gifts

A gift, often from parents, is acceptable when accompanied by a signed and notarized gift deed and full documentation of the giver's lawful source of funds, including employment income, business proceeds, asset sales or inheritance and supporting tax filings.

### Inheritance

Inherited funds qualify with a copy of the will, estate documents, bank statements showing the transfer and evidence of how the decedent originally accumulated the wealth.

### Asset Sales

Proceeds from the sale of property, securities or business interests can be used. USCIS requires sale agreements, bank records confirming the transfer, proof of the original purchase and the chain of ownership.

### Personal Income

Salary or business income earned before relocating to the United States can fund the investment. Required documentation includes pay slips, tax filings, employer letters and bank statements.

### Loans

Loans are permitted provided they are secured by the investor's personal assets. USCIS requires the loan agreement, evidence of the lender's capacity to fund the loan, documentation of the collateral and proof of fund transfer to the EB-5 escrow account. Unsecured personal loans are generally not accepted.

## Family Benefits and the Aging-Out Protection

An EB-5 investment covers the principal investor, their spouse and unmarried children under the age of 21. Once approved:

- Spouses receive green cards and may work for any employer or start a business
- Children attend U.S. schools as residents and qualify for in-state tuition and federal financial aid
- The full family becomes eligible to apply for U.S. citizenship after five years of permanent residency, which includes the two-year conditional period

The Child Status Protection Act (CSPA) freezes a dependent child's age on the day the I-526E petition is filed. This protects children who may turn 21 during the multi-year EB-5 process from aging out of the petition.

## Educational and Financial Benefits for F-1 Investors

Beyond the immigration outcome, F-1 students who transition to EB-5 unlock material education savings that can offset a meaningful portion of the investment:

- **In-state tuition:** Public university in-state tuition averages $10,000 to $15,000 per year versus $30,000 to $50,000 for international students. Over four undergraduate years, this savings can approach the EB-5 investment amount.
- **Federal financial aid:** Permanent residents qualify for FAFSA, federal student loans and a broader pool of scholarships closed to F-1 students.
- **Unrestricted work:** No CPT or OPT limits. Students can intern, accept assistantships, work off-campus and start businesses freely.
- **Healthcare access:** Permanent residents qualify for benefits and medical coverage unavailable to most non-immigrants.

## The Scale of the Problem: Why F-1 Students Should Act Now

More than 1.1 million international students are currently enrolled in the United States. Each year, the H-1B lottery allocates 85,000 visas against over 350,000 applicants, meaning roughly 75% of qualified graduates with employer sponsorship are forced to leave the country regardless of academic excellence. The EB-5 program removes that randomness entirely by making the green card outcome a function of capital and job creation rather than chance.

## Planning Ahead for Boarding School and High School Students

For families with children in U.S. boarding schools or high schools on F-1 visas, starting the EB-5 process early eliminates years of visa renewals, travel signatures and status maintenance. Filing during middle school or early high school allows the child to:

- Enter college as a permanent resident with full access to in-state tuition and federal aid
- Establish state residency before applying to public universities
- Participate in internships, paid research and extracurriculars closed to F-1 visa holders
- Build a college application without the administrative burden of maintaining nonimmigrant status

Because the EB-5 timeline from filing to green card commonly runs two to three years, families generally begin the process well before the child's senior year of high school.
