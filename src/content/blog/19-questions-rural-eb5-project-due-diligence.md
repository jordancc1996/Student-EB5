...
title: 19 EB-5 Due Diligence Questions to Ask Before Investing in a Rural Project
metaTitle: 19 EB-5 Due Diligence Questions to Ask Before Investing in a Rural Project | StudentEB5
...
image: ../../assets/blog-eb5-deal-analysis.jpg
heroImage: ../../assets/blog-eb5-deal-analysis.jpg
imageAlt: Investors analyzing EB-5 deal documents and financial charts in a professional meeting
...
keywords:
  ...
  - I-526 approval
  - I-829 petition
  - EB-5 repayment guarantee
  - developer equity
  - GMP contract
  - lien position
  - EB-5 investment risk
relatedPosts:
...
**Ideal Answer:** The project has a strong credit profile, a conservative <a href="/research/eb5-capital-stack">capital stack</a> and a low loan to value ratio. The senior loan is provided by a major bank and the developer has a significant amount of equity invested in the project. The EB-5 capital is the smallest portion of funds in the capital stack.
...
**Ideal Answer:** The project is 80% financed through institutional senior debt and developer equity. EB-5 capital is replacing 20% mezzanine debt that would cost 12-15% annually. The developer has equity investment in the project that represents over 20% of the total <a href="/research/eb5-capital-stack">capital stack</a>. For a deeper understanding of how these financing layers work, see our guide on <a href="/research/eb5-capital-stack">what is the EB-5 capital stack</a>.
...
<img src="/images/eb5-capital-stack.png" alt="The Safe Capital Stack - Ideal structure for EB-5 projects showing Senior Loan (50-60%), Developer Equity (20-25%), and EB-5 Capital (15-20%)" class="rounded-lg shadow-lg max-w-2xl w-full" />
<figcaption class="text-sm text-muted-foreground mt-3 text-center italic">The ideal capital stack structure for EB-5 projects</figcaption>
</figure>
...
Schedule your free EB-5 consultation or subscribe for expert insights at [studenteb5.com](https://studenteb5.com)

## Frequently Asked Questions

### How many EB-5 deals should a regional center have completed to demonstrate reliability?

A regional center should have a proven track record of managing multiple EB-5 projects with I-526 and I-829 approval rates of 95% or higher along with a history of timely and full capital repayment. This experience across all phases of the EB-5 journey is essential for investor confidence and a pivotal part of the due diligence process for EB-5 investors.

### What constitutes an ideal job cushion for an EB-5 project?

The ideal job cushion is 30 jobs created per investor which equates to 3x the USCIS minimum requirement of 10 jobs. This buffer helps mitigate risks such as construction delays. Projects that have already started construction are preferred due to their verifiability.

### Why is a Guaranteed Maximum Price (GMP) contract important in an EB-5 project?

A GMP contract caps construction costs with a reputable contractor thus reducing financial risk. This is a critical element along with a senior construction loan from a major financial institution and a completion guarantee to fully mitigate construction and market related risks.

### What is the typical payback period for an EB-5 investment and why is it structured that way?
