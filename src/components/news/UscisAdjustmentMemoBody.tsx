export default function UscisAdjustmentMemoBody() {
  return (
    <>
              <p>
              ...
              <h2 id="what-are-the-implications-for-eb-5-investors">What Are the Implications for EB-5 Investors?</h2>
              <p>
              ...
              <h2 id="strategic-considerations-for-pending-and-future-applicants">Strategic Considerations for Pending and Future Applicants</h2>
              <p>
              ...
              <h2 id="memo-final-thoughts">Memo Final Thoughts</h2>
              <p>
