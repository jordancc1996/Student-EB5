...
const article = getNewsArticle('uscis-adjustment-of-status-memo-eb5-investors')!;

const UscisAdjustmentMemoContent = () => (
  <NewsArticleShell article={article}>
              ...
              <h2>The Core Message of the Memo</h2>
              <p>
              ...
              <p>
                The memo does not alter the statutes that allow eligible foreign nationals to adjust their status to permanent resident while remaining in the United States. The <a href="/research/post-reform-integrity-act-analysis">EB-5 Reform and Integrity Act of 2022</a> permits concurrent filing of the I-526E immigrant petition and the I-485 application to register permanence or adjust status as long as a visa is available and current. This statutory provision is a core component of the modern EB-5 process for individuals contributing to the U.S. economy.
              </p>

              <h2>What Are the Implications for EB-5 Investors?</h2>
              <p>
              ...
              <h3>Positive Qualities Inherent in EB-5</h3>
              <p>EB-5 investors present a case for adjustment of status based on several factors including the following:</p>
              <ul>
                <li>
                  <strong>Economic contribution:</strong> the requirement of the EB-5 program is a capital investment in a U.S. commercial enterprise that creates and preserves at least 10 full-time jobs for U.S. workers. This economic benefit is a positive quality for EB-5 investors.
                </li>
                <li>
                  <strong>Lawful employment and tax history:</strong> many EB-5 investors, especially those transitioning from H-1B or L-1, have a documented history of lawful employment, paying U.S. taxes, and contributing to local communities.
                </li>
                <li>
                  <strong>Dual intent visas:</strong> individuals holding H-1B or L-1 visas are in dual intent classifications, meaning they are legally permitted to seek permanent residency while temporarily working in the United States. The memo acknowledges that holding these statuses is not incompatible with adjusting status.
                </li>
              </ul>

              <h3>Vulnerable Nonimmigrant Categories</h3>
              <p>
              ...
              <h2>Strategic Considerations for Pending and Future Applicants</h2>
              <p>
              ...
              <ul>
                ...
                <li>proof of property ownership or rental history</li>
                <li>community involvement</li>
                <li>and the enrollment of children in U.S. schools</li>
              </ul>
              <p>
              ...
              <h3>Consular Processing as an Alternative</h3>
              <p>
...
export default UscisAdjustmentMemoContent;
